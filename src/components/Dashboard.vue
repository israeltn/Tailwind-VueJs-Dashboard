<template>
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
        <div  class="fixed z-20 inset-0 bg-white opacity-50 transition-opacity lg:hidden"></div>
    
        <div  class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-white overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex items-center justify-center mt-8">
                <div class="flex items-center">
                    ...
                    <span class="text-Black text-xl mx-1 font-semibold">Co-thrift</span>
                </div>
            </div>
    
            <nav class="mt-5">
             <aside class="w-64" aria-label="Sidebar">
                <div class="overflow-y-auto  px-3 bg-gray-20 rounded dark:bg-gray-800">
                    <ul class="space-y-2">
                        <li>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8">
                   ...
                   <div class="grid gap-2 grid-cols-1 lg:grid-cols-2 w-full h-full mt-8">
                                    <div class="bg-white shadow-lg  h-[400px] w-full px-1 rounded-sm" id="chartline">
                                         <div  >
                                            <BarChart class="ml-1 p-4"  style=" height: 200px; width: 420px; "/>
                                        </div>
                                    </div>
                                  <div class="bg-white shadow-lg p-4 h-[400px]  px-1 " id="chartline">
                                        <div class=""  >
                                            <Doughnut style=" height: 342px; "/>
                                        </div>
                                   </div>
                                </div>
